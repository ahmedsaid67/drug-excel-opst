...
const DosageCalculator = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.get('http://127.0.0.1:8000/api/appname/hastalikhemyasahemkiloyabagliartandoz/get-detail-data/', {
                params: {
                    ilac_id: ilacId,
            ...
            if (parseInt(age) > threshold_age) {
                ...
                const responseWithoutKilo = await axios.get('http://127.0.0.1:8000/api/appname/hastalikhemyasahemkiloyabagliartandoz/get-hastalik-artan-doz-hem-kilo-hem-yas/', {
                    params: {
                        age,
                        ilac_id: ilacId,
                        hastalik_id: hastalikId
                ...
                console.log("data:",responseWithoutKilo.data)
            }
        } catch (error) {
    ...
    const handleKiloSubmit = async (event) => {
        ...
        try {
            ...
            const kiloResponse = await axios.get('http://127.0.0.1:8000/api/appname/hastalikhemyasahemkiloyabagliartandoz/get-hastalik-artan-doz-hem-kilo-hem-yas/', {
                params: {
                    age,
                    kilo,
                    ilac_id: ilacId,

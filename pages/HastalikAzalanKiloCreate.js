...
const UploadExcel = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('https://api.ölçek.com/api/appname/hastalikazalankilodoz/bulk_create_from_excel/', formData, {
                headers: {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Hastalık Azalan Kilo Doz Üret</h1>

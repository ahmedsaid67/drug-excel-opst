...
const UploadExcel = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/appname/hassasiyet-turu/bulk_create_from_excel/', formData, {
                headers: {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Hassasiyet Türü Üret</h1>

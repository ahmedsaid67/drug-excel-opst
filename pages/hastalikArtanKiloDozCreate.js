...
const UploadExcel = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/appname/hastalikartankilodoz/bulk_create_from_excel/', formData, {
                headers: {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Hastalık Artan Kilo Doz Üret</h1>

...
const UploadExcel = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('https://api.ölçek.com/api/appname/hastalikhemyasahemkiloyabagliazalandoz/bulk_create_from_excel/', formData, {
                headers: {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Hastalık Hem Kilo Hem Yaşa Bağlı Azalan Doz Üret</h1>

...
const UploadExcel = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('https://api.ölçek.com/api/appname/hastalikhemyasahemkiloyabagliartandoz/bulk_create_from_excel/', formData, {
                headers: {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Hastalık Hem Kilo Hem Yaşa Bağlı Artan Doz Üret</h1>
